...
set_target_properties(lib-xtb-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libxtb.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS lib-xtb-static )
list(APPEND _IMPORT_CHECK_FILES_FOR_lib-xtb-static "${_IMPORT_PREFIX}/lib/libxtb.a" )
...
set_target_properties(lib-xtb-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libxtb.so.6.6.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libxtb.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS lib-xtb-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_lib-xtb-shared "${_IMPORT_PREFIX}/lib/libxtb.so.6.6.0" )
